    ...
    <div class="separation-grid">
        ...
        <div class="Explicacion">
            ...
            <div class="galerie-vehicule">
              <div class="img1 car1">
                <img class="smallImage" src="/images/<?php echo $vehicule['image1']; ?>" alt="Image voiture BMW">
              </div>
              <div class="img1 car2">
                <img class="smallImage" src="/images/<?php echo $vehicule['image2']; ?>" alt="Image voiture galerie">
              </div>

              <div class="img1 car3">
                <img class="smallImage" src="/images/<?php echo $vehicule['image3']; ?>" alt="Image voiture galerie">
              </div>

              <div class="img1 car4">
                <img class="smallImage" src="/images/<?php echo $vehicule['image4']; ?>" alt="Image voiture galerie">
              </div>
